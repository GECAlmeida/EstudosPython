...
arquivo = open('C:\\Users\\gabri\\datascience\\EstudosPython\\ANO1_Fase2\\CAP7\\estudocsv\\arquivo_de_texto.txt')
print(type(arquivo))
#  print(arquivo.read())
...
with open('C:\\Users\\gabri\\datascience\\EstudosPython\\ANO1_Fase2\\CAP7\\estudocsv\\arquivo_de_texto.txt') as arquivo:
